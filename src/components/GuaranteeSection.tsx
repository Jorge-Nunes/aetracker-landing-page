        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {guarantees.map((guarantee, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-card rounded-lg p-6 border border-brand-red/20 hover:border-brand-red/40 transition-all duration-300 hover:shadow-red"
              >
        ...
        <div className="mt-16 text-center">
          <div className="bg-background rounded-lg p-8 border border-brand-red/20 max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed">
              "Garantimos que seu veículo estará protegido 24 horas por dia com a mais alta tecnologia 
              de rastreamento satelital. Se houver qualquer problema com nosso equipamento ou serviço, 
              assumimos total responsabilidade e solucionamos rapidamente."
            </p>
